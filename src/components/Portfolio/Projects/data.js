...
export const projects = [
  ...
  },
  {
    ...
    problem: "The client wanted a full-stack e-commerce marketplace with admin and user account priveleges. Upon registration, users can shop by category, by shop or search for items, add items to their cart. Admins can add, edit and delete items, shops and categories.",
    solution: "I built a full-stack e-commerce marketplace with admin and user account priveleges. Upon registration, users can shop by category, by shop or search for items, add items to their cart. Admins can add, edit and delete items, shops and categories.",
    image: "./project-3.gif",
